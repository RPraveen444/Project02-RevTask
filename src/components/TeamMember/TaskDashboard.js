...
const TaskDashboard = () => {
    ...
    const fetchUserData = async () => {
        try {
            const userResponse = await fetch(`http://localhost:8081/users/by-username?username=${username}`);
    ...
    const fetchProjects = async (username) => {
        try {
            const response = await fetch(`http://localhost:8081/projects/user/${username}`);
    ...
    const fetchTasksForProject = async (projectId) => {
        try {
            const response = await fetch(`http://localhost:8081/tasks/user/${userId}/project/${projectId}`);
            const data = await response.json();
    ...
    const fetchProjectManager = async (projectId) => {
        try {
            const response = await fetch(`http://localhost:8081/projects/${projectId}/manager`);
